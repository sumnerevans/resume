...
\setlist[itemize]{itemsep=-1.5pt,leftmargin=13pt}
...
\begin{itemize}
    ...
    \item Build and modify various backend services for managing our
...
\begin{itemize}
    \item CSCI 406 \textbf{Algorithms} in Fall 2018, Spring 2022, and Fall 2023. \\
        ...
        \begin{itemize}[topsep=-2pt]
            \item Developed new homework assignments for students who took an
...
\begin{itemize}
    % \item \textbf{Finding Your Home in Nix}
    %     --- LinuxFest Northwest
    %     \hfill \textit{October 2023} \\
    %     Explained and demoed Nix Home Manager, a tool for declaratively managing
    %     user home environments.
    \item \href{https://github.com/sumnerevans/hungryserv-presentation}{%
