...
\begin{itemize}
    \item I am working on bridges to connect people on every chat network
        through \textbf{Matrix}.
    \item I implemented a bridge to LinkedIn Messages using Python.
\end{itemize}

\textbf{Software Engineer} --- The Trade Desk --- Denver, CO
\hfill June 2019 - July 2021
\begin{itemize}
    \item I was a member of the Connected TV engineering team.
