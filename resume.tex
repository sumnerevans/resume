...
\begin{itemize}
    \item Reverse engineer and implemented many features for
        \href{https://blog.beeper.com/p/introducing-beeper-mini-get-blue}{\textbf{Beeper Mini}}
        including tapbacks, typing indicators, read receipts, edits, and unsends.
    \item Started a project called
        ...
        Worked on small team to productionize the project.
...
% {\fontsize{11}{0}\href{https://github.com/sumnerevans/lfnw23-nix-home-manager}{%
% \textbf{Finding Your Home in Nix}}
% --- LinuxFest Northwest}
% \hfill \textit{October 2023}
% \begin{itemize}
%     \item Explained and demoed Nix Home Manager, a tool for declaratively
%         managing user home environments.
% \end{itemize}
